defmodule WarwavexChanWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WarwavexChanWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WarwavexChanWeb.Gettext, "errors", msg, opts)
    end
  end
